...
public class RecipeRepository extends ModelRepository<Recipe> {
    ...
    public String  getNameForRestUrl() {
            ...
            public void createMany(  Map<String,  ? extends Object> data, final ObjectCallback<Recipe> callback){
            ...
            public void findCategoryRecipes(  String categoryId,  Map<String,  ? extends Object> filter, final ListCallback<Recipe> callback){
